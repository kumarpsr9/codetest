...
def compile_code(language, code):
    ramdomstring=generate_random_string(10)
    ...
    code_file = os.path.join(temp_dir, f"code_{hostname}_{ramdomstring}.{language}")
    output_file = os.path.join(temp_dir, f"output_{hostname}_{ramdomstring}")
